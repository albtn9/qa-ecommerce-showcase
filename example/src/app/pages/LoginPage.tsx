...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-rose-50 via-white to-pink-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
            ...
            <CardFooter className="flex justify-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Button variant="link" className="px-1" asChild>
                  <Link to="/signup" className="bg-gradient-to-r from-rose-500 to-pink-500 bg-clip-text text-transparent font-semibold">
                    Sign up
                  </Link>
                </Button>
              </p>
